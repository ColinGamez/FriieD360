  ...
  if (repairableItems.length === 0 && !repairResults) {
    return (
      <div className="p-20 flex flex-col items-center justify-center text-gray-500">
        <ShieldCheck size={64} className="text-xbox-green opacity-20 mb-4" />
        <h3 className="text-xl font-bold text-white">System Clean</h3>
        <p>No extensionless files detected in your library.</p>
      </div>
    );
  }
